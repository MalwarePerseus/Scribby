        ...
        <div className="max-w-6xl mx-auto px-4 py-10 md:py-20">
            <div className="flex md:flex-row justify-between items-center">
                ...
                <div className="space-x-8 hidden md:block">
                    <Link href="/features">
                        <a 
                            className={`text-base  ${router.asPath === "/features"? "text-gray-800 font-bold dark:text-gray-400": "text-gray-600 dark:text-gray-300 font-normal "
                            }`}
                        >   
                            Features{" "}
                    ...
                    <Link href="/login">
                        <a 
                            className={`text-base  ${router.asPath === "/login"? "text-gray-800 font-bold dark:text-gray-400": "text-gray-600 dark:text-gray-300 font-normal "
                            }`}
                        >   
                            Login
                            {router.asPath === "/login" && (
                    ...
                    <Link href="/signup">
                        <a 
                            className={`text-base  ${router.asPath === "/signup"? "text-gray-800 font-bold dark:text-gray-400": "text-gray-600 dark:text-gray-300 font-normal "
                            }`}
                        >   
                            Signup
