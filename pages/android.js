            ...
            <ContainerBlock>
                 <div className='lg:flex flex-row justify-between mx-20'>
                     <div className='mr-0 lg:w-1/2 py-20 mr-10'>
                         ...
                         <div className='w-60 mt-20 text-l p-2 rounded-r-full rounded-l-full text-center font-semibold from-purple-500 via-teal-500 to-blue-600 bg-gradient-to-br lg:text-2xl w-80'><span className='animate-pulse'>Coming Soon!</span></div>
                     </div>
